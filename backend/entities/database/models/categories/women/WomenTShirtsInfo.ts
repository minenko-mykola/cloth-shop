...
@Table({
    tableName: "women-tshirts-infos",
    timestamps: true
})
export class WomenTShirtsInfo extends Model<InferAttributes<WomenTShirtsInfo>,InferCreationAttributes<WomenTShirtsInfo>>
{
    @Column({
    ...
    declare fashion_type : TShirtFashion;
    ...
    declare sleeve_type : TShirtSleeveType
    ...
    declare sleeve_length : TShirtSleeveLength;
