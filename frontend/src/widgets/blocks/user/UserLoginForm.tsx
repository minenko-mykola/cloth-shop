...
import {UserLoginFormHook} from "@/widgets/blocks/shared/state-managers/hooks";
import {
...
export const UserLoginForm = observer(() => {
    ...
    const hook = UserLoginFormHook.hook!;
    ...
    return (
        <section>
            <form id="user-login-form" onSubmit={handleSubmit(onSubmit)}>
                <Dialog.Root
                    lazyMount
                                ...
                                <Dialog.Body>
                                    <section>
                                        <Field.Root required>
                                            ...
                                            <Input placeholder="Login" variant="outline" {...register("login",{
                                                required : true
                                            })} />
                                        ...
                                        <Stack>
                                            <Button variant="plain" onClick={() => {
                                                AuthenticationFormHandler.setStatus(AuthenticationSwitcherType.Register);
